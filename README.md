...
*   **⚖️ Resistance Training Tracking:** Quickly log exercises, sets, and reps with a UI optimized for speed and stability.
...
*   **📦 Muscle-Group Visualization:** Standardized anatomical tracking (e.g., "Front Deltoids") with localized intensity heatmaps.
